...
public class custom_order {
    ...
    // STEP 4 DISPLAY MENU
      ...
      System.out.println("MENU  QUALITY  BASE COST");
      System.out.println("Cake      1           $15");
      System.out.println(" Setup of Cupcakes 6  $15");
      System.out.println("_ _ _ _ _  _ _ _ _ _ _ _ ");
      System.out.println("Frostings (vanilla, chocolate)");
      System.out.println("Fillings (mocha, mint, lemon)");
      System.out.println("Toppings (sprinkles, cinnamon, coca)");
   ...
   System.out.println("What type of Frostings do you want?");
...
System.out.printf("The cost of your order is: *%.3f\n", cost);
tax = cost * TAX_RATE;
